...
public class BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.blue.client.menu.BlueMenuAppearance.BlueMenuResources {
  private static BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator _instance0 = new BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.blue.client.menu.BlueMenuAppearance.BlueMenuStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GCGCW0WDBSB{border:" + ("1px"+ " " +"solid")  + ";z-index:" + ("15000")  + ";zoom:" + ("1")  + ";background:" + ("repeat-y")  + ";outline:" + ("0"+ " " +"none")  + ";}.GCGCW0WDBSB a{text-decoration:" + ("none")  + " !important;}.GCGCW0WDCSB{padding:" + ("2px")  + ";background:" + ("transparent")  + ";border:" + ("0"+ " " +"none")  + ";overflow:" + ("hidden")  + ";overflow-y:") + (("hidden")  + ";}.GCGCW0WDASB{padding:" + ("0")  + " !important;}.GCGCW0WDASB .GCGCW0WDCSB{padding:" + ("0")  + ";}.GCGCW0WDBSB .GCGCW0WDFSB{margin:" + ("0")  + ";width:" + ("100%")  + ";background-position:" + ("center")  + ";background-repeat:" + ("no-repeat")  + ";height:" + ("8px")  + ";line-height:" + ("8px")  + ";cursor:" + ("pointer")  + ";padding:" + ("0") ) + (";}.GCGCW0WDBSB .GCGCW0WDGSB{height:" + ("6px")  + ";line-height:" + ("6px")  + ";}.GCGCW0WDDSB{padding-right:" + ("27px")  + " !important;}.GCGCW0WDJSB{background-image:" + ("none")  + ";}.GCGCW0WDBSB{width:" + ((BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.menu()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.menu()).getSafeUri().asString() + "\") -" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.menu()).getLeft() + "px -" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.menu()).getTop() + "px  repeat-y")  + ";width:" + ("auto")  + ";border-color:" + ("#718bb7")  + ";background-color:" + ("#f0f0f0")  + ";}.GCGCW0WDKSB{background-color:") + (("#fff")  + " !important;}.GCGCW0WDISB{height:" + ((BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getHeight() + "px")  + ";width:" + ((BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getSafeUri().asString() + "\") -" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getLeft() + "px -" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getTop() + "px  no-repeat")  + ";}.GCGCW0WDHSB{height:" + ((BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getHeight() + "px")  + ";width:" + ((BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getSafeUri().asString() + "\") -" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getLeft() + "px -" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getTop() + "px  no-repeat")  + ";}.GCGCW0WDFSB{border-width:" + ("1px"+ " " +"0")  + ";}")) : ((".GCGCW0WDBSB{border:" + ("1px"+ " " +"solid")  + ";z-index:" + ("15000")  + ";zoom:" + ("1")  + ";background:" + ("repeat-y")  + ";outline:" + ("0"+ " " +"none")  + ";}.GCGCW0WDBSB a{text-decoration:" + ("none")  + " !important;}.GCGCW0WDCSB{padding:" + ("2px")  + ";background:" + ("transparent")  + ";border:" + ("0"+ " " +"none")  + ";overflow:" + ("hidden")  + ";overflow-y:") + (("hidden")  + ";}.GCGCW0WDASB{padding:" + ("0")  + " !important;}.GCGCW0WDASB .GCGCW0WDCSB{padding:" + ("0")  + ";}.GCGCW0WDBSB .GCGCW0WDFSB{margin:" + ("0")  + ";width:" + ("100%")  + ";background-position:" + ("center")  + ";background-repeat:" + ("no-repeat")  + ";height:" + ("8px")  + ";line-height:" + ("8px")  + ";cursor:" + ("pointer")  + ";padding:" + ("0") ) + (";}.GCGCW0WDBSB .GCGCW0WDGSB{height:" + ("6px")  + ";line-height:" + ("6px")  + ";}.GCGCW0WDDSB{padding-left:" + ("27px")  + " !important;}.GCGCW0WDJSB{background-image:" + ("none")  + ";}.GCGCW0WDBSB{width:" + ((BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.menu()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.menu()).getSafeUri().asString() + "\") -" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.menu()).getLeft() + "px -" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.menu()).getTop() + "px  repeat-y")  + ";width:" + ("auto")  + ";border-color:" + ("#718bb7")  + ";background-color:" + ("#f0f0f0")  + ";}.GCGCW0WDKSB{background-color:") + (("#fff")  + " !important;}.GCGCW0WDISB{height:" + ((BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getHeight() + "px")  + ";width:" + ((BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getSafeUri().asString() + "\") -" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getLeft() + "px -" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getTop() + "px  no-repeat")  + ";}.GCGCW0WDHSB{height:" + ((BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getHeight() + "px")  + ";width:" + ((BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getSafeUri().asString() + "\") -" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getLeft() + "px -" + (BlueMenuAppearance_BlueMenuResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getTop() + "px  no-repeat")  + ";}.GCGCW0WDFSB{border-width:" + ("1px"+ " " +"0")  + ";}"));
      }
