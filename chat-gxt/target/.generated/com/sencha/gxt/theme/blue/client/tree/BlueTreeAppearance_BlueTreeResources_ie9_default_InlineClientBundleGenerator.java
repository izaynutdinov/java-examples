...
public class BlueTreeAppearance_BlueTreeResources_ie9_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.blue.client.tree.BlueTreeAppearance.BlueTreeResources {
  private static BlueTreeAppearance_BlueTreeResources_ie9_default_InlineClientBundleGenerator _instance0 = new BlueTreeAppearance_BlueTreeResources_ie9_default_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.base.client.tree.TreeBaseAppearance.TreeBaseStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GCGCW0WDLLB{cursor:" + ("default")  + ";-moz-outline:" + ("none")  + ";-moz-user-focus:" + ("none")  + ";outline:" + ("0"+ " " +"none")  + ";position:" + ("relative")  + ";padding-bottom:" + ("1px")  + ";min-height:" + ("1%")  + ";}.GCGCW0WDHLB{cursor:" + ("default")  + ";}.GCGCW0WDELB{white-space:" + ("nowrap")  + ";height:" + ("21px")  + ";}.GCGCW0WDBLB{display:") + (("none")  + ";}.GCGCW0WDKLB{white-space:" + ("nowrap")  + ";line-height:" + ("11px")  + ";text-decoration:" + ("none")  + ";padding:" + ("0"+ " " +"3px"+ " " +"0"+ " " +"0")  + ";display:" + ("inline-block")  + ";vertical-align:" + ("top")  + ";margin-top:" + ("3px")  + ";font:" + ("normal"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"verdana"+ ","+ " " +"sans-serif")  + ";color:" + ("black")  + ";}.GCGCW0WDCLB{background-image:" + ("none") ) + (" !important;background-color:" + ("#defadc")  + " !important;}.GCGCW0WDILB{background-color:" + ("#eee")  + ";}.GCGCW0WDDLB{background-color:" + ("#defadc")  + ";}.GCGCW0WDJLB{background-color:" + ("#d9e8fb")  + " !important;}")) : ((".GCGCW0WDLLB{cursor:" + ("default")  + ";-moz-outline:" + ("none")  + ";-moz-user-focus:" + ("none")  + ";outline:" + ("0"+ " " +"none")  + ";position:" + ("relative")  + ";padding-bottom:" + ("1px")  + ";min-height:" + ("1%")  + ";}.GCGCW0WDHLB{cursor:" + ("default")  + ";}.GCGCW0WDELB{white-space:" + ("nowrap")  + ";height:" + ("21px")  + ";}.GCGCW0WDBLB{display:") + (("none")  + ";}.GCGCW0WDKLB{white-space:" + ("nowrap")  + ";line-height:" + ("11px")  + ";text-decoration:" + ("none")  + ";padding:" + ("0"+ " " +"0"+ " " +"0"+ " " +"3px")  + ";display:" + ("inline-block")  + ";vertical-align:" + ("top")  + ";margin-top:" + ("3px")  + ";font:" + ("normal"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"verdana"+ ","+ " " +"sans-serif")  + ";color:" + ("black")  + ";}.GCGCW0WDCLB{background-image:" + ("none") ) + (" !important;background-color:" + ("#defadc")  + " !important;}.GCGCW0WDILB{background-color:" + ("#eee")  + ";}.GCGCW0WDDLB{background-color:" + ("#defadc")  + ";}.GCGCW0WDJLB{background-color:" + ("#d9e8fb")  + " !important;}"));
      }
