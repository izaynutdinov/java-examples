...
public class TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.base.client.field.TextAreaDefaultAppearance.TextAreaResources {
  private static TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator _instance0 = new TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator();
  private void cssInitializer() {
    css = new com.sencha.gxt.theme.base.client.field.TextAreaDefaultAppearance.TextAreaStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? (("input.GCGCW0WDOW,textarea.GCGCW0WDOW{border:" + ("1px"+ " " +"solid"+ " " +"#7eadd9")  + ";}input.GCGCW0WDPW,textarea.GCGCW0WDPW{height:" + ((TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.invalidLine()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.invalidLine()).getSafeUri().asString() + "\") -" + (TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.invalidLine()).getLeft() + "px -" + (TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.invalidLine()).getTop() + "px  repeat-x")  + ";background-color:" + ("#fff")  + ";background-position:" + ("bottom")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#c30")  + ";height:" + ("18px")  + ";line-height:" + ("18px")  + ";}.GCGCW0WDCX{position:" + ("relative")  + ";right:") + (("0")  + ";top:" + ("0")  + ";zoom:" + ("1")  + ";white-space:" + ("nowrap")  + ";text-align:" + ("right")  + ";white-space:" + ("normal")  + ";}.GCGCW0WDMW{font:" + ("12px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GCGCW0WDLW{color:" + ("gray")  + ";}.GCGCW0WDBX{height:" + ((TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.textBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.textBackground()).getSafeUri().asString() + "\") -" + (TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.textBackground()).getLeft() + "px -" + (TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.textBackground()).getTop() + "px  repeat-x") ) + (";height:" + ("auto")  + ";background-color:" + ("#fff")  + ";border:" + ("1px"+ " " +"#b5b8c8"+ " " +"solid")  + ";padding:" + ("1px"+ " " +"3px")  + ";resize:" + ("none")  + ";height:" + ("18px")  + ";line-height:" + ("18px")  + ";vertical-align:" + ("top")  + ";}.GCGCW0WDKW{background-color:" + ("#fff")  + ";border:" + ("1px"+ " " +"#b5b8c8"+ " " +"solid")  + ";padding:") + (("1px"+ " " +"3px")  + ";resize:" + ("none")  + ";overflow:" + ("visible")  + ";}")) : (("input.GCGCW0WDOW,textarea.GCGCW0WDOW{border:" + ("1px"+ " " +"solid"+ " " +"#7eadd9")  + ";}input.GCGCW0WDPW,textarea.GCGCW0WDPW{height:" + ((TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.invalidLine()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.invalidLine()).getSafeUri().asString() + "\") -" + (TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.invalidLine()).getLeft() + "px -" + (TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.invalidLine()).getTop() + "px  repeat-x")  + ";background-color:" + ("#fff")  + ";background-position:" + ("bottom")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#c30")  + ";height:" + ("18px")  + ";line-height:" + ("18px")  + ";}.GCGCW0WDCX{position:" + ("relative")  + ";left:") + (("0")  + ";top:" + ("0")  + ";zoom:" + ("1")  + ";white-space:" + ("nowrap")  + ";text-align:" + ("left")  + ";white-space:" + ("normal")  + ";}.GCGCW0WDMW{font:" + ("12px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GCGCW0WDLW{color:" + ("gray")  + ";}.GCGCW0WDBX{height:" + ((TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.textBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.textBackground()).getSafeUri().asString() + "\") -" + (TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.textBackground()).getLeft() + "px -" + (TextAreaDefaultAppearance_TextAreaResources_ie10_default_InlineClientBundleGenerator.this.textBackground()).getTop() + "px  repeat-x") ) + (";height:" + ("auto")  + ";background-color:" + ("#fff")  + ";border:" + ("1px"+ " " +"#b5b8c8"+ " " +"solid")  + ";padding:" + ("1px"+ " " +"3px")  + ";resize:" + ("none")  + ";height:" + ("18px")  + ";line-height:" + ("18px")  + ";vertical-align:" + ("top")  + ";}.GCGCW0WDKW{background-color:" + ("#fff")  + ";border:" + ("1px"+ " " +"#b5b8c8"+ " " +"solid")  + ";padding:") + (("1px"+ " " +"3px")  + ";resize:" + ("none")  + ";overflow:" + ("visible")  + ";}"));
      }
