...
public class SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.base.client.widget.SplitBarDefaultAppearance.SplitBarResources {
  private static SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator _instance0 = new SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator();
  private void cssInitializer() {
    css = new com.sencha.gxt.theme.base.client.widget.SplitBarDefaultAppearance.SplitBarStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GCGCW0WDIOB{position:" + ("absolute")  + ";z-index:" + ("3")  + ";}.GCGCW0WDJOB{cursor:" + ("s-resize")  + ";cursor:" + ("row-resize")  + ";font-size:" + ("1px")  + ";line-height:" + ("1px")  + ";}.GCGCW0WDBPB{cursor:" + ("w-resize")  + ";cursor:" + ("col-resize")  + ";}.GCGCW0WDAPB{position:" + ("absolute")  + ";background-color:" + ("#929090")  + ";font-size:") + (("1px")  + ";line-height:" + ("1px")  + ";z-index:" + ("200")  + ";}.GCGCW0WDKOB{position:" + ("absolute")  + ";top:" + ("0")  + ";right:" + ("0")  + ";display:" + ("block")  + ";width:" + ("5px")  + ";height:" + ("35px")  + ";cursor:" + ("pointer")  + ";opacity:" + ("0.5") ) + (";}.GCGCW0WDNOB{opacity:" + ("1")  + ";filter:" + ("none")  + ";opacity:" + ("1")  + ";}.GCGCW0WDMOB{border:" + ("0"+ " " +"none")  + ";width:" + ("5px")  + " !important;padding:" + ("0")  + ";}.GCGCW0WDOOB{border:" + ("0"+ " " +"none")  + ";width:" + ("5px")  + " !important;padding:" + ("0")  + ";height:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniRight()).getHeight() + "px")  + ";width:") + (((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniRight()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniRight()).getSafeUri().asString() + "\") -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniRight()).getLeft() + "px -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniRight()).getTop() + "px  no-repeat")  + ";top:" + ("48%")  + ";}.GCGCW0WDMOB{height:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniLeft()).getHeight() + "px")  + ";width:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniLeft()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniLeft()).getSafeUri().asString() + "\") -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniLeft()).getLeft() + "px -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniLeft()).getTop() + "px  no-repeat")  + ";top:" + ("48%")  + ";}.GCGCW0WDPOB{height:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getHeight() + "px")  + ";width:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getWidth() + "px") ) + (";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getSafeUri().asString() + "\") -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getLeft() + "px -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getTop() + "px  no-repeat")  + ";}.GCGCW0WDLOB{height:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getHeight() + "px")  + ";width:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getSafeUri().asString() + "\") -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getLeft() + "px -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getTop() + "px  no-repeat")  + ";}.GCGCW0WDPOB,.GCGCW0WDLOB{height:" + ("5px")  + ";right:" + ("50%")  + ";margin-right:" + ("-17px")  + ";width:" + ("35px")  + ";}")) : ((".GCGCW0WDIOB{position:" + ("absolute")  + ";z-index:" + ("3")  + ";}.GCGCW0WDJOB{cursor:" + ("s-resize")  + ";cursor:" + ("row-resize")  + ";font-size:" + ("1px")  + ";line-height:" + ("1px")  + ";}.GCGCW0WDBPB{cursor:" + ("e-resize")  + ";cursor:" + ("col-resize")  + ";}.GCGCW0WDAPB{position:" + ("absolute")  + ";background-color:" + ("#929090")  + ";font-size:") + (("1px")  + ";line-height:" + ("1px")  + ";z-index:" + ("200")  + ";}.GCGCW0WDKOB{position:" + ("absolute")  + ";top:" + ("0")  + ";left:" + ("0")  + ";display:" + ("block")  + ";width:" + ("5px")  + ";height:" + ("35px")  + ";cursor:" + ("pointer")  + ";opacity:" + ("0.5") ) + (";}.GCGCW0WDNOB{opacity:" + ("1")  + ";filter:" + ("none")  + ";opacity:" + ("1")  + ";}.GCGCW0WDMOB{border:" + ("0"+ " " +"none")  + ";width:" + ("5px")  + " !important;padding:" + ("0")  + ";}.GCGCW0WDOOB{border:" + ("0"+ " " +"none")  + ";width:" + ("5px")  + " !important;padding:" + ("0")  + ";height:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniRight()).getHeight() + "px")  + ";width:") + (((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniRight()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniRight()).getSafeUri().asString() + "\") -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniRight()).getLeft() + "px -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniRight()).getTop() + "px  no-repeat")  + ";top:" + ("48%")  + ";}.GCGCW0WDMOB{height:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniLeft()).getHeight() + "px")  + ";width:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniLeft()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniLeft()).getSafeUri().asString() + "\") -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniLeft()).getLeft() + "px -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniLeft()).getTop() + "px  no-repeat")  + ";top:" + ("48%")  + ";}.GCGCW0WDPOB{height:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getHeight() + "px")  + ";width:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getWidth() + "px") ) + (";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getSafeUri().asString() + "\") -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getLeft() + "px -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniTop()).getTop() + "px  no-repeat")  + ";}.GCGCW0WDLOB{height:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getHeight() + "px")  + ";width:" + ((SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getSafeUri().asString() + "\") -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getLeft() + "px -" + (SplitBarDefaultAppearance_SplitBarResources_ie10_default_InlineClientBundleGenerator.this.miniBottom()).getTop() + "px  no-repeat")  + ";}.GCGCW0WDPOB,.GCGCW0WDLOB{height:" + ("5px")  + ";left:" + ("50%")  + ";margin-left:" + ("-17px")  + ";width:" + ("35px")  + ";}"));
      }
